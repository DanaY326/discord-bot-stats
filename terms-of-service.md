...
This Terms of Service Agreement (the "Agreement") is entered into between Dana Yuan ("Bot Owner") and the user ("User") of the Message Analyzer Discord bot (the "Bot").
...
8. Governing Law: This Agreement shall be governed by and construed in accordance with the laws of Canada and the Province of Ontario. Any dispute arising under or in connection with this Agreement shall be resolved by arbitration.
